...
public class MoteurPhysiqueVol {
	...
	/**
	 * Méthode qui calcule les divers paramètres de la fusée pour un intervalle de temps pendant le décollage
	...
	/**
	 * Méthode qui calcule l'accélération d'un objet à partir de la somme des forces excercées sur lui, sa masse et son inclinaison et qui modifie son vecteur accélération.
	 * @param acceleration Le vecteur accélération de l'objet
	 * @param sommeForce le vecteur représentant la somme des forces sur l'objet
	...
	/**
	 * Méthode qui calcule le changement de vitesse et qui modifie le vecteur vitesse en fonction du vecteur accélération et du deltaT donné
