...
/**
 * La classe MoteurPhysiqueOrbite est composée de méthodes permettant de calculer des variables physiques durant le vol orbital
 * @author James Huynh
 *
 */
public class MoteurPhysiqueOrbite {
	...
	/**
	 * Méthode pour déterminer le vecteur du système de contrôle par réaction (RCS) dans l'espace
	 * @param touche L'entrée informatique d'une touche 
	...
	/**
	 * Méthode pour effectuer la somme de tous les forces exercées sur la fusée dans l'espace
