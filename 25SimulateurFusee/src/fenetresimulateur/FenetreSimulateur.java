...
public class FenetreSimulateur extends JFrame {
	...
	private final String MESSAGE_A_PROPOS = "Réalisé par Thomas Corbeil et James Huynh" + "\n" + "420-SCD" + "\n" + "Hiver 2016-2017" + "\n" + "Collège de Maisonneuve";
	...
	//Thomas
	/**
	 * Méthode qui met à jour les données pendant le décollage
	 */
	...
	//Thomas
	/**
	 * Méthode qui permet de désélectionner une pièce
	 * @param indice l'indice du type de pièce à désélectionner
	 */
	...
	//Thomas
	/**
	 * Méthode qui initialise les composantes d'interfaces d'assemblage aux valeurs désirées
	 */
	...
	//Thomas
	/**
	* Méthode qui initialise les composantes d'interfaces de vol aux valeurs désirées
	*/
	 ...
	 * @param facteur le facteur d'écoulement du temps
	 */
	...
	//James
	/**
	 * Méthode qui charge une image de lignes diagonales
	 */
	...
	//Thomas
	/**
	 * Méthode qui crée des étiquettes personnalisées pour le slider du temps
	 */
