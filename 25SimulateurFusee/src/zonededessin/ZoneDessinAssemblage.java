...
public class ZoneDessinAssemblage extends JPanel {
	...
	public ZoneDessinAssemblage(Pieces[] pieces) {
		...
		URL urlImageCarre = ZoneDessinAssemblage.class.getResource(nomImageCarre); //Cherche l'image du contour carrée des petites pièces
	...
	/**
	 * Méthode pour créer les régions détectables dans la partie droite de l'assemblage
	 */
	...
	/**
	 * Méthode qui gère le clic droit
	 * @param point Le point associé au clic droit
	 */
	...
	/**
	 * Méthode qui gère les conséquences du déplacement de la souris
	...
	/**
	 * Méthode permettant de faire une levée d'événement pour signaler la sélection d'une pièce
	...
	/**
	 * Méthode permettant de faire une levée d'événement pour signaler la déselection d'une pièce
