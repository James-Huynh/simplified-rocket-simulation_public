...
public class Pieces implements Dessinable, DessinablePixel, DessinableGrandissement {
	 ...
	 * @param nomImage le nom de l'image utilisée pour représenter la piece
	...
	/**
	 * Getter retournant la largeur de la pièce
	 ...
	 * @param largeur la largeur désirée de la pièce 
	 */
	 ...
	 * @param hauteur la hauteur désirée de la pièce 
	 */
	...
	/**
	 * Getter qui retourne une image carrée à la pièce
	 * @return l'image carrée à associer à la pièce
	 */
	public Image getImageCarre() {
		return imageCarree;
	}
	/**
	 * Setter qui retourne l'image carrée associée à la pièce
	 * @param imageCarre l'image carrée associée à la pièce
	 */
